...
internal data class OrangeBusinessToolsLinkTokens(
    ...
    override val sizeMinHeightSmall: Float = OudsDimensionRawTokens.Dimension450,
    override val sizeMinWidthDefault: OudsSizeKeyToken = OudsSizeKeyToken.MinInteractiveArea,
    override val sizeMinWidthSmall: Float = OudsDimensionRawTokens.Dimension450,
