...
/**
 * An annotated string for [com.orange.ouds.core.component.OudsHeadingText] text in OUDS components.
 *
 * This class supports colored text formatting to highlight one or more important words in a heading.
 *
 * Use [buildOudsAnnotatedHeadingText] to create instances:
 * ```
 * OudsHeadingText(
