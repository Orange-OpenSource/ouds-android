...
data class OudsSpacings(
    ...
    val fixedHuge: Dp,
    val fixedJumbo: Dp,
    val scaledNone: OudsAdaptiveTokenValue,
    val scaledSmash: OudsAdaptiveTokenValue,
    val scaledShortest: OudsAdaptiveTokenValue,
    val scaledShorter: OudsAdaptiveTokenValue,
    val scaledShort: OudsAdaptiveTokenValue,
    val scaledMedium: OudsAdaptiveTokenValue,
    val scaledTall: OudsAdaptiveTokenValue,
    val scaledTaller: OudsAdaptiveTokenValue,
    val scaledTallest: OudsAdaptiveTokenValue,
    val scaledSpacious: OudsAdaptiveTokenValue,
