...
@Composable
fun OudsLinearProgressIndicatorDeterminateSample() {
...
@Composable
fun OudsLinearProgressIndicatorIndeterminateSample() {
    OudsLinearProgressIndicator(
        helperText = "Loading..."
    )
}
...
@PreviewLightDark
@Composable
private fun PreviewOudsLinearrProgressIndicatorDeterminateSample() = OudsPreview {
