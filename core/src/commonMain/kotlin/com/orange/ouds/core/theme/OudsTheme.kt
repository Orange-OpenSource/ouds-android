...
internal val LocalWindowWidthSizeClass = staticCompositionLocalOf<WindowWidthSizeClass> { missingCompositionLocalError("LocalWindowWidthSizeClass") }
internal val LocalWindowWidth = staticCompositionLocalOf<Dp> { missingCompositionLocalError("LocalWindowWidth") }
...
fun OudsTheme(
    ...
    with(theme) {
        ...
        BoxWithConstraints {
            val windowWidthSizeClass = WindowWidthSizeClass.compute(maxWidth)
            CompositionLocalProvider(
                LocalDarkThemeEnabled provides darkThemeEnabled,
                LocalHighContrastModeEnabled provides isHighContrastModeEnabled(),
