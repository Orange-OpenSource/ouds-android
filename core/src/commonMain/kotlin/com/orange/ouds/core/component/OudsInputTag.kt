...
import ouds_android.core.generated.resources.core_inputTag_remove_a11y
        ...
        Box(
            modifier = Modifier
                ...
                .clickable(
                    ...
                    onClick = onClick,
                    onClickLabel = stringResource(Res.string.core_inputTag_remove_a11y),
                    role = Role.Button
                ),
            ...
            Row(
                ...
                Icon(
                    modifier = Modifier.size(tagTokens.sizeAssetDefault.value * LocalDensity.current.fontScale),
