...
internal sealed class OudsAlertStatus(
    ...
    class Negative(
        ...
        defaultIconContentDescriptionProvider: (@Composable (OudsAlertStatus) -> String) = { stringResource(Res.string.core_common_error_a11y) }
    ...
    class Warning(
        defaultIconPainterProvider: (@Composable (OudsAlertStatus) -> Painter?) = { getDefaultIconPainter(it) },
        defaultIconContentDescriptionProvider: (@Composable (OudsAlertStatus) -> String) = { stringResource(Res.string.core_common_warning_a11y) }
    ) :
        OudsAlertStatus(defaultIconPainterProvider, defaultIconContentDescriptionProvider)
