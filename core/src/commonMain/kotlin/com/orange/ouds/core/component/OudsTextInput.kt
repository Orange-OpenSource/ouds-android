                        ...
                        if (hasError) {
                            Box(
                                ...
                                Icon(
                                    ...
                                    contentDescription = if (error.message.isBlank()) stringResource(Res.string.core_common_error_a11y) else null,
...
@Composable
internal fun OudsTextInputHelperTextErrorMessage(
    enabled: Boolean,
    error: OudsError?,
    helperText: String?,
    annotatedHelperText: OudsAnnotatedHelperText?,
...
) : OudsComponentIcon<OudsTextInputLeadingIcon.ExtraParameters, OudsTextInputLeadingIcon>(ExtraParameters::class, graphicsObject, contentDescription) {
