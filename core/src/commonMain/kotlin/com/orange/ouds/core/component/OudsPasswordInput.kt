...
import ouds_android.core.generated.resources.core_passwordInput_hidePassword_a11y
import ouds_android.core.generated.resources.core_passwordInput_showPassword_a11y
...
private fun trailingIconButton(isPasswordHidden: Boolean, onClick: () -> Unit): OudsTextInputTrailingIconButton {
    ...
    if (isPasswordHidden) {
        ...
        contentDescriptionResource = Res.string.core_passwordInput_showPassword_a11y
    } else {
