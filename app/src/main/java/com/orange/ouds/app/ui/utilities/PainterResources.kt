...
@Composable
fun rememberUntintedRoundedIconPainter(): Painter {
    val painter = painterResource(R.drawable.ic_untinted_square)
...
@Composable
fun rememberImagePainter(): Painter {
    val painter = painterResource(R.drawable.ic_untinted_widescreen)
    val backgroundColor = untintedPainterBackgroundColor
    return remember(painter) {
        object : Painter() {
            override val intrinsicSize: Size
