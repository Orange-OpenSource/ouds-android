...
fun NavigationBarDemoScreen() {
    ...
    DemoScreen(
        ...
        version = OudsVersion.Component.Bar // TODO Update to NavigationBar version when available
    )
}
...
private fun NavigationBarDemoBottomSheetContent(state: NavigationBarDemoState) {
    with(state) {
        ...
        CustomizationFilterChips(
            ...
            label = stringResource(R.string.app_components_navigationBar_itemCount_tech),
        ...
        CustomizationFilterChips(
            ...
            label = stringResource(R.string.app_components_navigationBar_lastItemBadge_tech),
