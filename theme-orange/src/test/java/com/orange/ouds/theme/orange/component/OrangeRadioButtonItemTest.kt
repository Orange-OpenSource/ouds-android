...
class OrangeRadioButtonItemTest : OudsRadioButtonItemTest() {

    class Parameterized(parameter: OudsRadioButtonItemPreviewParameter) : OudsRadioButtonItemTest.Parameterized(parameter, OrangeTheme())

    class ParameterizedHighContrastMode(parameter: OudsRadioButtonItemHighContrastModePreviewParameter) :
        OudsRadioButtonItemTest.ParameterizedHighContrastMode(parameter, OrangeTheme())

    class NonParameterized() : OudsRadioButtonItemTest.NonParameterized(OrangeTheme())
}
