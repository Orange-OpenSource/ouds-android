...
data class OrangeLinkTokens(
    ...
    override val colorChevronFocus: OudsColorKeyToken = OudsColorKeyToken.Content.BrandPrimary,
    override val colorChevronHover: OudsColorKeyToken = OudsColorKeyToken.Content.BrandPrimary,
    override val colorChevronPressed: OudsColorKeyToken = OudsColorKeyToken.Content.BrandPrimary,
    ...
    override val sizeIconDefault: OudsSizeKeyToken.Icon = OudsSizeKeyToken.Icon.WithLabel.Large.SizeXsmall,
    ...
    override val spaceColumnGapChevronDefault: OudsSpaceKeyToken.ColumnGap = OudsSpaceKeyToken.ColumnGap.2xsmall,
    override val spaceColumnGapChevronSmall: OudsSpaceKeyToken.ColumnGap = OudsSpaceKeyToken.ColumnGap.2xsmall,
    override val spaceColumnGapIconDefault: OudsSpaceKeyToken.ColumnGap = OudsSpaceKeyToken.ColumnGap.Small,
    override val spaceColumnGapIconSmall: OudsSpaceKeyToken.ColumnGap = OudsSpaceKeyToken.ColumnGap.Xsmall,
