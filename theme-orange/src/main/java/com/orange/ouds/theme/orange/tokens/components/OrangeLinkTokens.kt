...
data class OrangeLinkTokens(
    override val colorArrowEnabled: OudsColorKeyToken = OudsColorKeyToken.Content.BrandPrimary,
    override val colorArrowFocus: OudsColorKeyToken = OudsColorKeyToken.Content.BrandPrimary,
    override val colorArrowHover: OudsColorKeyToken = OudsColorKeyToken.Content.BrandPrimary,
    override val colorArrowPressed: OudsColorKeyToken = OudsColorKeyToken.Content.BrandPrimary,
