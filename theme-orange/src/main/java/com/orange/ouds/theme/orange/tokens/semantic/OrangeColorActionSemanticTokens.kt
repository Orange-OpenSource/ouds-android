...
data class OrangeColorActionSemanticTokens(
    ...
    override val actionReadOnlyPrimaryDark: Color = ColorRawTokens.colorOpacityWhite640,
    override val actionReadOnlyPrimaryLight: Color = ColorRawTokens.colorOpacityBlack680,
