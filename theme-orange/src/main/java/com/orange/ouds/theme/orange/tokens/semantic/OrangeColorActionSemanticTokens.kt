...
data class OrangeColorActionSemanticTokens(
    ...
    override val actionVisitedLight: Color = OrangeBrandColorRawTokens.colorDecorativeAmethyst600,
    override val actionVisitedDark: Color = OrangeBrandColorRawTokens.colorDecorativeAmethyst400,
