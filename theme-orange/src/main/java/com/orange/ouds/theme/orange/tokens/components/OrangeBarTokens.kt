...
data class OrangeBarTokens(
    override val borderRadiusTopActiveIndicator: OudsBorderKeyToken.Radius = OudsBorderKeyToken.Radius.None,
    override val colorBg: OudsLightDarkColorToken = OudsLightDarkColorToken(Color(0xccf4f4f4), Color(0xcc1f1f1f)),
    override val colorBorder: OudsColorKeyToken = OudsLightDarkColorKeyToken(OudsColorKeyToken.Repository.Opacity.Black.Lowest, OudsColorKeyToken.Repository.Opacity.White.Lowest),
