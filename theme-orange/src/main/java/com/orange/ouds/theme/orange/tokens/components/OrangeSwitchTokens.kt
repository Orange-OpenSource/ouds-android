...
data class OrangeSwitchTokens(
    ...
    override val colorTrackSelected: OudsColorKeyToken = OudsLightDarkColorKeyToken(OudsColorKeyToken.Repository.Positive.High, OudsColorKeyToken.Repository.Positive.Default),
    ...
    override val spacePaddingInlineSelected: OudsSpaceKeyToken.PaddingInline = OudsSpaceKeyToken.PaddingInline.3xsmall,
    override val spacePaddingInlineUnselected: OudsSpaceKeyToken.PaddingInline = OudsSpaceKeyToken.PaddingInline.Xsmall
) : OudsSwitchTokens
