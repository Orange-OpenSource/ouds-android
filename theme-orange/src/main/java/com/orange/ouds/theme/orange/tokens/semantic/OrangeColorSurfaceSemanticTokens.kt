...
data class OrangeColorSurfaceSemanticTokens(
    ...
    override val surfaceStatusAccentMutedDark: Color = OrangeColorRawTokens.colorWarmGray900,
    override val surfaceStatusAccentMutedLight: Color = OrangeColorRawTokens.colorOpacityWarmGray,
