...
data class OrangeControlItemTokens(
    ...
    override val spaceColumnGap: OudsSpaceKeyToken.ColumnGap = OudsSpaceKeyToken.ColumnGap.Large,
    override val spaceInset: OudsSpaceKeyToken.Inset = OudsSpaceKeyToken.Inset.Medium,
