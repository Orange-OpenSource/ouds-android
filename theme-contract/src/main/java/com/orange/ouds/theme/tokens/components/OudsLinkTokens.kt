...
open class OudsLinkTokens(
    ...
    val colorContentDisabledMono: Color = ColorRawTokens.colorOpacityBlack280,
    val colorContentEnabled: OudsColorKeyToken = OudsColorKeyToken.Action.Enabled,
    val colorContentEnabledMono: Color = ColorRawTokens.colorFunctionalBlack,
    val colorContentFocus: OudsColorKeyToken = OudsColorKeyToken.Action.Focus,
    val colorContentFocusMono: Color = ColorRawTokens.colorFunctionalBlack,
    val colorContentHover: OudsColorKeyToken = OudsColorKeyToken.Action.Hover,
    val colorContentHoverMono: Color = ColorRawTokens.colorFunctionalBlack,
    val colorContentPressed: OudsColorKeyToken = OudsColorKeyToken.Action.Pressed,
    val colorContentPressedMono: Color = ColorRawTokens.colorOpacityBlack680,
