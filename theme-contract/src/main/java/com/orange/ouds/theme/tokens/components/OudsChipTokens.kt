...
open class OudsChipTokens(
    ...
    val badgeColorContent: OudsColorKeyToken = OudsColorKeyToken.Content.OnStatus.Emphasized,
    ...
    val spacePaddingBlock: OudsSpaceKeyToken.PaddingBlock = OudsSpaceKeyToken.PaddingBlock.Shorter,
    val spacePaddingBlockIconOnly: OudsSpaceKeyToken.PaddingBlock = OudsSpaceKeyToken.PaddingBlock.Short,
    val spacePaddingInlineIcon: OudsSpaceKeyToken.PaddingInline = OudsSpaceKeyToken.PaddingInline.Short,
    val spacePaddingInlineIconNone: OudsSpaceKeyToken.PaddingInline = OudsSpaceKeyToken.PaddingInline.Tall,
    val spacePaddingInlineArrowEnd: OudsSpaceKeyToken.PaddingInline = OudsSpaceKeyToken.PaddingInline.Shorter,
    val spacePaddingInlineBadgeStart: OudsSpaceKeyToken.PaddingInline = OudsSpaceKeyToken.PaddingInline.Smash,
    val spaceColumnGapIcon: OudsSpaceKeyToken.ColumnGap = OudsSpaceKeyToken.ColumnGap.Shorter,
    val spaceColumnGapBadgeArrow: OudsSpaceKeyToken.ColumnGap = OudsSpaceKeyToken.ColumnGap.Shortest,
    ...
    val sizeMinHeightInteractiveArea: Float = 48f
)
