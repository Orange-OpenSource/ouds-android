...
data class OudsColorContentSemanticTokens(
    ...
    val contentOnStatusEmphasizedAltLight: Color = ColorRawTokens.colorFunctionalWhite,
    ...
    val contentOnStatusEmphasizedAltDark: Color = ColorRawTokens.colorFunctionalBlack,
