...
open class OudsButtonTokens(
    ...
    val verticalContentPadding: OudsDimensionSpaceToken = OudsDimensionSpaceToken.Smash,
    val horizontalContentPadding: OudsDimensionSpaceToken = OudsDimensionSpaceToken.Tall
)