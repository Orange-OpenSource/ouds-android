...
interface OudsColorActionSemanticTokens {
    ...
    val actionReadOnlyPrimaryDark: Color
    val actionReadOnlyPrimaryLight: Color
    val actionReadOnlySecondaryDark: Color
    val actionReadOnlySecondaryLight: Color
    val actionSelectedDark: Color
    val actionSelectedLight: Color
    val actionSupportDisabledDark: Color
    val actionSupportDisabledLight: Color
