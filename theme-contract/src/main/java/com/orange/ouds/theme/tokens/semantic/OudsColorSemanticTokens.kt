...
data class OudsColorSemanticTokens(
    val globalColorTokens: OudsGlobalColorSemanticTokens = OudsGlobalColorSemanticTokens(),
    val actionColorTokens: OudsActionColorSemanticTokens = OudsActionColorSemanticTokens(),
    val alwaysColorTokens: OudsAlwaysColorSemanticTokens = OudsAlwaysColorSemanticTokens(),
    val backgroundColorTokens: OudsBgColorSemanticTokens = OudsBgColorSemanticTokens(),
    val borderColorTokens: OudsBorderColorSemanticTokens = OudsBorderColorSemanticTokens(),
    val brandColorTokens: OudsBrandColorSemanticTokens = OudsBrandColorSemanticTokens(),
    val contentColorTokens: OudsContentColorSemanticTokens = OudsContentColorSemanticTokens(),
    val elevationColorTokens: OudsElevationColorSemanticTokens = OudsElevationColorSemanticTokens(),
    val gradientColorTokens: OudsGradientColorSemanticTokens = OudsGradientColorSemanticTokens(),
