...
open class OudsCheckboxTokens(
    ...
    val colorContentDisabled: OudsColorKeyToken = OudsColorKeyToken.Repository.Opacity.Black.Transparent,
    val colorContentEnabled: OudsColorKeyToken = OudsColorKeyToken.Repository.Opacity.Black.Transparent,
    val colorContentFocus: OudsColorKeyToken = OudsColorKeyToken.Action.Support.Focus,
    val colorContentHover: OudsColorKeyToken = OudsColorKeyToken.Action.Support.Hover,
    val colorContentLoading: OudsColorKeyToken = OudsColorKeyToken.Action.Support.Loading,
    val colorContentPressed: OudsColorKeyToken = OudsColorKeyToken.Action.Support.Pressed,
