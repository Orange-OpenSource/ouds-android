...
interface OudsGridSemanticTokens {
    ...
    val extraLargeColumnGap: Int
    val extraLargeMargin: Int
    val extraLargeMaxWidth: Int
    val extraLargeMinWidth: Int
    val largeColumnGap: Int
    val largeMargin: Int
    val largeMaxWidth: Int
    val largeMinWidth: Int
