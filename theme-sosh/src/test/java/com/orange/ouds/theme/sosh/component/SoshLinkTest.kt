...
class SoshLinkTest : OudsLinkTest() {

    class Parameterized(parameter: OudsLinkPreviewParameter) : OudsLinkTest.Parameterized(parameter, SoshTheme())

    class NonParameterized() : OudsLinkTest.NonParameterized(SoshTheme())
}
