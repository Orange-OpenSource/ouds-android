...
internal data class SoshSwitchTokens(
    ...
    override val colorTrackSelected: OudsColorKeyToken = OudsLightDarkColorKeyToken(OudsColorKeyToken.Repository.Secondary.Low, OudsColorKeyToken.Repository.Secondary.Lower),
    override val colorTrackSelectedInteraction: OudsColorKeyToken = OudsLightDarkColorKeyToken(OudsColorKeyToken.Repository.Secondary.Medium, OudsColorKeyToken.Repository.Secondary.Lowest),
