...
data class SoshBadgeTokens(
    ...
    override val spacePaddingInlineLarge: OudsSpaceKeyToken.PaddingInline = OudsSpaceKeyToken.PaddingInline.2xsmall,
    override val spacePaddingInlineMedium: OudsSpaceKeyToken.PaddingInline = OudsSpaceKeyToken.PaddingInline.3xsmall
) : OudsBadgeTokens
