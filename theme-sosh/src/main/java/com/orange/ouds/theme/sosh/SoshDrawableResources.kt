...
internal class SoshDrawableResources : OudsDrawableResources {
    ...
    override val topAppBarDelete: Int = R.drawable.ic_sosh_top_app_bar_delete
    override val topAppBarFormChevronLeft: Int = R.drawable.ic_sosh_top_app_bar_form_chevron_left
    override val topAppBarMenu: Int = R.drawable.ic_sosh_top_app_bar_menu
