...
internal class SoshDrawableResources : OudsDrawableResources {
    ...
    class Component : OudsDrawableResources.Component {
        ...
        class ListItem : OudsDrawableResources.Component.ListItem {
            override val next = R.drawable.ic_sosh_component_list_item_next
            override val previous = R.drawable.ic_sosh_component_list_item_previous
        }
    ...
    class Other : OudsDrawableResources.Other {
        override val headingTextMarker = null
    }
}
