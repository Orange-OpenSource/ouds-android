...
data class SoshLinkTokens(
    override val colorArrowEnabled: OudsColorKeyToken = OudsColorKeyToken.Action.Enabled,
    override val colorArrowFocus: OudsColorKeyToken = OudsColorKeyToken.Action.Enabled,
    override val colorArrowHover: OudsColorKeyToken = OudsLightDarkColorKeyToken(OudsColorKeyToken.Content.BrandPrimary, OudsColorKeyToken.Action.Enabled),
    override val colorArrowPressed: OudsColorKeyToken = OudsColorKeyToken.Action.Pressed,
    ...
    override val spaceColumnGapArrowDefault: OudsSpaceKeyToken.ColumnGap = OudsSpaceKeyToken.ColumnGap.TwoExtraSmall,
    override val spaceColumnGapArrowSmall: OudsSpaceKeyToken.ColumnGap = OudsSpaceKeyToken.ColumnGap.TwoExtraSmall,
