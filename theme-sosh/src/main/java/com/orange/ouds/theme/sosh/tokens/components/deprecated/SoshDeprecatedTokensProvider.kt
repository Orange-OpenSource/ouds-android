...
import com.orange.ouds.theme.sosh.tokens.components.SoshButtonTokens

internal interface SoshDeprecatedTokensProvider<T> : OudsDeprecatedTokensProvider<T> {

    @Suppress("UNCHECKED_CAST")
    override val deprecated: T
        get() = when (this) {
            is SoshButtonTokens -> SoshDeprecatedButtonTokens() as T
