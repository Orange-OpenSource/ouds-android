...
data class SoshButtonTokens(
    ...
    override val colorBgBrandLoading: OudsColorKeyToken = OudsLightDarkColorKeyToken(OudsColorKeyToken.Repository.Primary.Default, OudsColorKeyToken.Repository.Secondary.Lower),
    override val colorBgBrandPressed: OudsColorKeyToken = OudsLightDarkColorKeyToken(OudsColorKeyToken.Repository.Primary.Default, OudsColorKeyToken.Repository.Secondary.Lower),
