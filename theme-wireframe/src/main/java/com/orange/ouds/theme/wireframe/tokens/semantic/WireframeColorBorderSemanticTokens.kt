...
internal data class WireframeColorBorderSemanticTokens(
    ...
    override val borderMutedDark: Color = WireframeColorRawTokens.ColorOpacityWhite120,
    override val borderMutedLight: Color = WireframeColorRawTokens.ColorOpacityBlack120,
