...
internal data class WireframeCheckboxTokens(
    override val borderRadius: OudsBorderKeyToken.Radius = OudsBorderKeyToken.Radius.Small,
    ...
    override val borderWidthUnselected: OudsBorderKeyToken.Width = OudsBorderKeyToken.Width.Medium,
    ...
    override val sizeMaxHeight: OudsSizeKeyToken = OudsSizeKeyToken.MinInteractiveAreaDefault,
    override val sizeMinHeight: OudsSizeKeyToken = OudsSizeKeyToken.MinInteractiveAreaDefault,
    override val sizeMinWidth: OudsSizeKeyToken = OudsSizeKeyToken.MinInteractiveAreaDefault
) : OudsCheckboxTokens
